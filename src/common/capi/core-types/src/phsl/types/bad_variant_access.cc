...
#include "phsl/types/bad_variant_access.h"
    ...
    #else
        #include "phsl/base/internal/raw_logging.h"
    #endif
...
void ThrowBadVariantAccess()
{
    ...
    #else
    PBSL_RAW_LOG(FATAL, "Bad variant access");
...
void Rethrow()
{
    ...
    #else
    PBSL_RAW_LOG(FATAL,
                 "Internal error in phsl::variant implementation. Attempted to "
