...
#ifndef PBSL_BASE_POLICY_CHECKS_H_
#define PBSL_BASE_POLICY_CHECKS_H_
...
// We support GCC 6 and later.
// This minimum will go up.
#if defined(__GNUC__) && !defined(__clang__)
    #if __GNUC__ < 6
        #error "This package requires GCC 6 or higher."
    #endif
#endif
...
#endif  // PBSL_BASE_POLICY_CHECKS_H_
